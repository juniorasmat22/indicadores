...
<body>
    ...
    <header class="header black-bg">
        ...
        <ul class="nav top-menu">
          ...
          <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
              ...
              <li>
                <a href="index.html#">
                  <span class="photo"><img alt="avatar" src="recursos/dashio/img/ui-zac.jpg"></span>
                  <span class="subject">
              ...
              <li>
                <a href="index.html#">
                  <span class="photo"><img alt="avatar" src="recursos/dashio/img/ui-divya.jpg"></span>
                  <span class="subject">
              ...
              <li>
                <a href="index.html#">
                  <span class="photo"><img alt="avatar" src="recursos/dashio/img/ui-danro.jpg"></span>
                  <span class="subject">
              ...
              <li>
                <a href="index.html#">
                  <span class="photo"><img alt="avatar" src="recursos/dashio/img/ui-sherman.jpg"></span>
                  <span class="subject">
      ...
      <div class="top-menu">
        <ul class="nav pull-right top-menu">
          <li><a class="logout" href="?c=usuario&a=cerrarSesion">Logout</a></li>
        </ul>
      </div>
    </header>
    <!--header end-->
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="?c=persona&a=verPerfil"><img src="recursos/dashio/img/ui-sam.jpg" class="img-circle" width="80"></a></p>
  ...
  <script class="include" type="text/javascript" src="recursos/dashio/lib/jquery.dcjqaccordion.2.7.js"></script>
  <script src="recursos/dashio/lib/jquery.scrollTo.min.js"></script>
  <script src="recursos/dashio/lib/jquery.nicescroll.js" type="text/javascript"></script>
...
<script type="text/javascript" src="recursos/dashio/lib/bootstrap-fileupload/bootstrap-fileupload.js"></script>
  ...
  if ($var=='unidadNegocio') {
    echo "  <script src='recursos/dashio/lib/jquery-ui-1.9.2.custom.min.js'></script>
    <script type='text/javascript' src='recursos/dashio/lib/bootstrap-datepicker/js/bootstrap-datepicker.js'></script>
<script src='recursos/dashio/lib/advanced-form-components.js'></script>";
  }
  if ($var=="formula") {
