<div class="modal-header">
  ...
  <h4 class="modal-title" id="myModalLabel">Registar Proceso</h4>
</div>
<div class="modal-body">
  <div class="row mt">
    <div class="col-lg-12">
        <div class="form">
          <form class="cmxform form-horizontal style-form" method="post" action="?c=proceso&a=crear" id="formCrear" autocomplete="off">
              <input type="hidden" name="idMapaProcesos" value="<?php echo $_GET['idMapaProcesos']; ?>">
