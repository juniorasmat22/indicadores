<div class="modal-header">
  ...
  <h4 class="modal-title" id="myModalLabel">Editar Datos- Unidad de Negocio</h4>
</div>
<div class="modal-body">
  <div class="row mt">
    <div class="col-lg-12">
        <div class="form">
          <form class="cmxform form-horizontal style-form" method="post" action="?c=unidadNegocio&a=editar" id="formEditar" autocomplete="off" >
              <input type="hidden" name="idUnidadNegocio" >
