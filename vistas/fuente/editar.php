...
<div class="modal-body">
  <div class="row mt">
    <div class="col-lg-12">
        <div class="form">
          <form class="cmxform form-horizontal style-form" method="post" action="?c=fuente&a=editar" id="formEditar" autocomplete="off">
            <input type="hidden" name="idFuente" >
              ...
              <div class="form-group ">
                <label for="sede" class="control-label col-lg-4">Sede</label>
                <div class="col-lg-8">
