    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <div class="custom-box">
          ...
          <div id="chart-container-valle"></div>
        </div>
        <!-- end custombox -->
      </div>
      <!-- end col-4 -->
            ...
            <div class="row">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <table class="table table-striped table-advance table-hover table-responsive">
                  ...
                  <tbody>
                    <?php
                     if($fuente_valle->respuesta){
                       $filas=$fuente_valle->resultado;
                    ...
                    <tr>
                      ...
                      <td>
                          <button class="btn btn-info btn-xs" onclick="ver_grafico('chart-container-valle','<?php echo $respuesta->resultado->descripcion; ?>','<?php echo $fila->periodo; ?>',<?php echo $fila->resultado; ?>,<?php echo $respuesta->resultado->rojo; ?>,<?php echo $respuesta->resultado->amarillo; ?>,<?php echo $respuesta->resultado->verde; ?>);"><i class="fa fa-dashboard"></i> semáforo</button >
                      </td>
                    </tr>
                    <?php
                        }
  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="custom-box">
        <div class="servicetitle">
          <h4><?php echo $respuesta->resultado->descripcion; ?>-SEDE VALLE</h4>
          <span><select id="periodo2" name="periodo2" class="pull-right" required onchange="llenar_grafico_sede(<?php echo $_GET['idIndicador'] ;?>,2);">
            <option value="" disabled selected >Seleccione una opción</option>
            <?php if ($fuente_valle->respuesta):
              $filas=$fuente_valle->resultado;
              $periodo_anterior='';
              foreach ($filas as $fila){
                ?>
          ...
          <hr>
  <?php if ($fuente_valle->respuesta){?>
            <div class="custom-bar-chart" id="2">
              <ul class="y-axis">
                <li><span>100</span></li>
                <li><span>80</span></li>
                <li><span>60</span></li>
